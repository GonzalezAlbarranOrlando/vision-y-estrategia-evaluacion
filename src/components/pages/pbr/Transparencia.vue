          ...
          <div class="card-body ext-box" style="min-height: 320px;">
            <div class="int-box">
              ...
              <div class="general-text">
                <p>
                  El apoyo financiero de Despacho de Consultores Visión y Estrategia
              es solventado por sus socios y ha decidido reservar un porcentaje
              para conservar una estabilidad financiera, adicionalmente se
              cuenta con una fianza contratada para asegurar el cumplimiento de
              cada servicio, derechos y deberes de solicitantes y clientes.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="col-12 col-md-11 col-xl-5 py-2">
        ...
        <div class="card">
          ...
          <div class="card-body ext-box" style="min-height: 200px;">
            <div class="int-box">
              <h3 class="my-h3">DERECHOS Y DEBERES DE LOS CLIENTES</h3>
              <div class="general-text">
                <p>
                  Puedes descargar el contrato de prestación de servicios
                  <a
                      class="download-here"
                      href="/docx/Contrato de Presupuesto basado en Resultados.docx"
                      target="_blank"
                    >
                      aquí </a
                    >.
            ...
            <div class="int-box">            
              ...
              <div class="general-text">
                <p>
                  ...
                  <a
                      class="download-here"
                      href="/docx/procedimiento de quejas PbR.docx"
                      target="_blank"
                    >
                      aquí </a
                    >.
