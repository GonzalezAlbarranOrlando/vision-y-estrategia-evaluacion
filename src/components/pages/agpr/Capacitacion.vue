  ...
  <div class="container">
    ...
    <div class="row table-row">
      <div class="col-12 table-title">
        Nombre del taller: Implantación del Sistema de Gestión para Resultados
      ...
      <div class="col-12 table-white">
        ...
        <ul>
          <li>
            ...
            gobiernos en la implementación de los cambios institucionales para
            mejorar la efectividad de estos, mediante la implantación del
            Sistema de gestión para resultados en el sector público.
          </li>
        </ul>
      </div>
      <div class="col-12 table-blue">
        ...
        <ul>
          ...
          <li>
            ...
            planificación, presupuesto, gestión financiera, gestión de programas
            y proyectos y seguimiento - evaluación.
          </li>
        </ul>
      </div>
      <div class="col-12 table-white">
    ...
    <div class="row table-row">
      <div class="col-12 table-title">
        Nombre del curso: Módulo I. Planeación de un Sistema de Administración
        por Resultados
      </div>
      <div class="col-12 table-white">
        <b>Objetivo:</b>
      ...
      <div class="col-12 table-blue">
        ...
        <ul>
          ...
          <li>
            Identificar las fortalezas y debilidades de los sistemas de
            planificación, presupuesto, gestión financiera, gestión de programas
            y proyectos y seguimiento - evaluación de los gobiernos.
          </li>
        </ul>
      </div>
      <div class="col-12 table-white">
    ...
    <div class="row table-row">
      ...
      <div class="col-12 table-blue">
        ...
        <ul class="ul-clean">
          <li>4.1. Conceptualización y diseño de indicadores.</li>
          <li>
            4.2. Tipos de indicadores (Gestión, procesos, riesgos, estratégicos
            y de desempeño).
          </li>
          <li>4.3. Control de riesgos.</li>
          <li>
    ...
    <div class="row table-row">
      ...
      <div class="col-12 table-white">
        ...
        Garantía de satisfacción: Avalamos la transmisión de conocimientos a
        través der una metodología que permita elegir la información para el
        diseño de productos o resultados. <br />
        <br />
        Constancia: Al término del curso se otorgará una constancia de
        participación con valor curricular, con la insignia de Gobernova.
      </div>
